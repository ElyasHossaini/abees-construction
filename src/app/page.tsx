        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-black">Modern Kitchen Renovation</h3>
                <p className="text-black">Complete kitchen transformation with custom cabinets, quartz countertops, and premium finishes.</p>
              </div>
            </div>
